...
import { getAtlasBachatBalancedPlan } from '../../../../../../config/api/whatWeOffer';



export const AtlasBachatBalancedPlan = () => {
  const {isLoading, error, data, refetch}: any = useQuery(
    'getAtlasBachatBalancedPlan',
    getAtlasBachatBalancedPlan,
  ...
  return (
    <>
      ...
      <DetailList
        ...
        interval={1}
        headerTitle={languageTxt.atlasBachatBalancedPlanTxt}
      />
    </>
  );
};
